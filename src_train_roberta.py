# Same logic as train_bert.py but using roberta-base
import argparse
...
def main():
    ...
    ap.add_argument("--output_dir", default="results/checkpoints/roberta")
    args = ap.parse_args()
    cfg = load_config(args.config)
    set_seed(cfg["seed"])
    model_name = cfg["models"]["roberta"]
    ...
    log("Training complete for RoBERTa.")
